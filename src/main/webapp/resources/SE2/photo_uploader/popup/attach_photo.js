	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/ex6/file/seUpload',	//★★★★★여기에다가 파일업로드 주소를 쓰는거야, 무조건 controller부터 가겠지? 어느 폴더에서 파일을 올릴지 모르니까 절대경로가 좋음
 			//sUrl  : '/file_uploader.do',	//샘플 URL입니다.
 	        sCallback : '/resources/SE2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소 //★★★★★ 경로 조정
