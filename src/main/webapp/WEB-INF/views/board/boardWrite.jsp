...
$(function(){
    ...
    nhn.husky.EZCreator.createInIFrame({
        ...
        elPlaceHolder: "smarteditor", //textarea에 아이디야
...
<p>내용: <textarea id="smarteditor" rows="" cols="" name="contents">${dto.contents}</textarea></p>
<p><input type="button" id="savebutton" value="LOGIN"></p>
</form>
</body>
</html>